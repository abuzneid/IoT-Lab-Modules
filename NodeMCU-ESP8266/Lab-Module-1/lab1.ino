...
#include <ESP8266WiFi.h> //we are using Node mcu
...
postStr += String(t);  // upload temperature which was in variable t

postStr +="&field2=";

postStr += String(h); // upload humidity which was in variable h
